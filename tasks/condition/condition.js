...
if (y<10) {
    z1=x+y;
    console.log(`y < 10, z1 = x+y = ${z1}`)
} else if (y>=10) {
    z1=x*y;
    console.log(`y >= 10, z2 = x*y = ${z1}`)
}
...
if (redemption>0 && redemption<350) {discount=0}
else if(redemption>351 && redemption<1350) {discount=15}
else if(redemption>1351 && redemption<2700) {discount=30}
else if(redemption>2701 && redemption<6500) {discount=45}
